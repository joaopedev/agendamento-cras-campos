...
export const Cadastro: React.FC = () => {
	...
	const handleDataNascimentoAndPasswordChange = (e: ChangeEvent<HTMLInputElement>) => {
				...
				>
					...
					<form onSubmit={handleSubmit(handleRegister)}>
						...
						<FormControl isInvalid={!!errors.data_nascimento}>
							<FormLabel htmlFor="data-de-nascimento">Data de nascimento</FormLabel>
							<InputGroup>
								<Input
							...
							render={({ field }) => (
								<FormControl isInvalid={!!errors.endereco?.bairro}>
									...
									<Select
										...
										{...field}
									>
										<option value="">Selecione seu bairro</option> {/* Placeholder */}
