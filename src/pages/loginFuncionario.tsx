...
import { Flex, Stack, Box, Input, InputLeftElement, InputGroup } from '@chakra-ui/react';
		...
		<Flex h="100vh">
			...
			>
				...
				>
					...
					<InputGroup>
						<Input // Input for data de nascimento
							placeholder="Senha" // Change placeholder here
							value={dataNascimento}
							onChange={handleDataNascimentoChange}
							type="password" // hide the characters
							size="md"
							sx={{
								fontSize: ['0.7rem', '0.8rem', '0.9rem', '1rem'],
								bg: 'white',
